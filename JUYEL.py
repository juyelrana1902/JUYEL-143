...
def _____UpDaTe_xOx_____():
	fb_version=f"{random.randint(499, 521)}.{random.randint(0, 0)}.{random.randint(0, 0)}.{random.randint(31, 42)}.{random.randint(60, 97)}"
	fb_version_code=str(random.randint(10000000, 66666666))
	application_version_code=str(random.randint(000000000,999999999))
	dwh = random.choice(["1080|2.0|2460","720|1.6|1612","720|2.0|1600","720|1.3|1560","720|2.0|1440","1080|2.0|2460","720|2.0|1500","720|2.0|1440","720|1.6|1613","1080|2.3|2408"])
	...
	mobile_model=random.choice(["TECNO KG8","TECNO KG5n","Tecno Mobile X689F","Tecno Mobile X620B","Tecno Mobile X657","Tecno Mobile X6816C","Tecno Mobile-X552","Tecno Mobile X693","Tecno Mobile X509","Tecno Mobile X603"])
